                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contacts__map ">
                            <?php echo do_shortcode('[yamap center="56.2344,43.4920" height="22rem" controls="" zoom="14" type="yandex#map" scrollzoom="0" mobiledrag="0"][yaplacemark coord="56.23430543343597,43.49069270651565" icon="islands#dotIcon" color="#1e98ff"][yaplacemark coord="56.2344,43.4892" icon="islands#dotIcon" color="#1fff39"][/yamap]') ?>                            
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed"> 
                            <?php echo do_shortcode('[contact-form-7 id="137" title="Форма отзывов"]') ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">

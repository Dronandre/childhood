...
<div class="reply">
    <div class="reply__body">
        ...
        <?php echo do_shortcode('[contact-form-7 id="138" title="Форма с модалки"]') ?>        
    </div>
</div>
<footer>
    <div class="container">
...
wp_footer();
?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC7Xa9u2fTJX1WEvvaP-suswws9ZuRVoXo"></script>
